          ...
          <div className="flex gap-4 flex-col sm:flex-row">
            ...
            <div>
              ...
              {adminPrivileges.managedCategories === "all" ? (
                ...
                <div className="px-4 py-2 border border-gray-200 bg-gray-100 text-gray-700 rounded-lg shadow-sm text-base">
          ...
          <div className="flex items-end gap-4">
            ...
            {managedJobCategories?.some(cat => cat.name === "Food Handler") && (
              <div>
                ...
                <Link href="/dashboard/attendance-tracker" className="flex items-center justify-center bg-emerald-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-emerald-700">Track Attendance</Link>
              </div>
            )}
            {/* Search Input */}
